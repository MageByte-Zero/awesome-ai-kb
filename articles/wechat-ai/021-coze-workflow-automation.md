---
title: "码哥用扣子搭了一套自动跟进工作流，每天省2小时这不是夸张"
alt_titles:
  - "每周花3小时手动汇总信息发钉钉通知，这事我再也不做了"
  - "不写代码，用扣子把微信群、表格、钉钉通知串成自动流水线"
  - "你每天重复的「收集→整理→发通知」，扣子5分钟帮你做完"
  - "扣子工作流到底能做多复杂的事？我搭了一套「自动跟进流水线」测试"
description: "扣子（Coze）自动化工作流实战：不写代码，用拖拽把信息收集、飞书表格、钉钉通知串成一条自动流水线。码哥工程师视角教你哪里好用、哪里有坑，帮你今天就能上手。"
date: "2026-05-17"
keywords: ["扣子工作流", "Coze自动化", "钉钉通知", "飞书表格", "零代码工作流"]
platform: "微信公众号"
source: "实测"
cover: "https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/021-coze-workflow-automation-cover.png"
---

![封面图](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/021-coze-workflow-automation-cover.png)
...
![扣子工作流职场痛点场景：手动处理信息的烦恼](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/021-coze-workflow-automation-fig01-scene.png)
...
![扣子工作流前后对比：手动处理vs自动化](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/021-coze-workflow-automation-fig02-before-after.png)
...
对于我朋友的场景，我们选择了最简单的方式：每次他把新客户信息**通过扣子机器人手动粘贴进来**，工作流自动处理后续的表格写入和通知发送。这样不需要对接外部系统，直接在钉钉里就能用。
...
![扣子工作流搭建步骤流程图](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/021-coze-workflow-automation-fig03-flow.png)
...
- [扣子官方文档 - 工作流入门](https://www.coze.cn/open/docs/guides/agent_workflow)
- [扣子价格方案对比](https://www.mabiji.com/coze/banbenkouzi.html)
- [钉钉自定义机器人开发文档](https://open.dingtalk.com/document/robots/custom-robot-access)

扣子这类工具最大的价值不是帮你做更多事，而是**把你从重复劳动里解放出来，让你把时间用在真正需要判断的地方**。那 80 分钟不是"省了"，是你重新拥有了——用来见客户、写方案、或者早点回家。
