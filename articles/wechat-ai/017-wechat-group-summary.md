...
alt_titles:
  ...
  - "wx-cli 2.3k Star 工具+Claude Code，我把群聊信息量压缩了 90%"
  - "群消息每天几百条，不会总结微信群的人已经在落后了"
  - "我用一个工具把微信群聊变成了 5 分钟日报，数据从没上过云"
description: "用 wx-cli 本地导出微信群聊记录，配合 Claude Code 自定义 Skill，实现 5 分钟内完成群聊 AI 摘要，全程数据不上云。适合每天要盯多个工作群的互联网人。"
date: "2026-05-16"
keywords: ["微信群聊总结", "wx-cli", "Claude Code Skill", "微信消息导出", "AI 总结工具"]
platform: "微信公众号"
source: "GitHub Trending"
cover: "https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/017-wechat-group-summary-cover.png"
---

![手动翻群40分钟变5分钟，wx-cli + Claude Code Skill 本地微信群聊总结器](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/017-wechat-group-summary-cover.png)
...
![wx-cli + Claude Code 本地数据处理架构图](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/017-wechat-group-summary-fig01-arch.png)
...
![wx-cli 内存扫描解密原理图](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/017-wechat-group-summary-fig02-flow.png)
...
![数据安全全本地处理流程图](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/017-wechat-group-summary-fig03-security.png)
