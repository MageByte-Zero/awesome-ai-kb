---
title: "136000星的Agent技能市场，90%的人还不知道怎么上车"
description: "Agent Skills正在成为AI编程的新标准——anthropics/skills单日900星累计13.6万星，Superpowers破19.4万星，25+平台已接入。本文从Skill的本质讲起，厘清与MCP Server、Plugin的核心区别，手把手教你开发第一个Skill，并附上10年架构师对这场生态爆发的独家判断。"
date: "2026-05-17"
keywords: ["Agent Skills", "SKILL.md", "Claude Code", "AI编程", "MCP", "Superpowers", "Anthropic"]
platform: "微信公众号"
source: "GitHub Trending / Anthropic 官方 / agentskills.io"
alt_titles:
  - "一个文件夹值13.6万星：Agent Skills凭什么改变AI编程范式"
  - "用了3个月Claude Code才发现，这个功能才是最值钱的"
  - "码哥实测：写了20行SKILL.md，Claude的代码质量提升了一倍"
  - "别再只写Prompt了，给AI装技能才是2026年AI编程的正确打开方式"
---
...
![Skills生态全景图：anthropics/skills、Superpowers、agentskills.io 与 25+ Agent 平台的关系](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/020-anthropic-skills-ecosystem-boom-fig01-ecology.png)
...
![Skills生态层级结构：从底层规范(L1)到Agent平台(L5)的五层架构](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/020-anthropic-skills-ecosystem-boom-fig02-layer.png)
...
![Skills安全与治理模型：风险面识别 -> 团队治理流程 -> 四级信任体系](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/020-anthropic-skills-ecosystem-boom-fig03-security.png)
