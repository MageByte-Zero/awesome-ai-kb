---
title: "飞书官方开源 10.9k Star 的 CLI，让 AI 帮你发消息不再是定时炸弹"
alt_titles:
  - "我让 AI 帮我群发飞书通知，差点发出去一条"测试请忽略""
  - "AI 帮你发飞书消息，发错了怎么办？lark-cli 这个机制让我放心了"
  - "用了 lark-cli 一个月，AI 操作飞书再也没出过岔子——说说真实体验"
  - "飞书 CLI 开源 45 天 1 万星，90% 的人只用了它最表层的功能"
description: "飞书官方开源 lark-cli（10.9k stars），覆盖 17 个业务域 200+ 命令，配套 24 个 Claude Code AI Agent Skills。本文从安装配置到 --dry-run 安全机制，再到与 Claude Code 集成的实战路径，带你搭出真正敢用的 AI 飞书操作链路。"
date: "2026-05-16"
keywords: ["lark-cli", "飞书 CLI", "larksuite cli", "AI Agent 飞书", "Claude Code 飞书", "dry-run", "飞书自动化"]
platform: "微信公众号"
source: "GitHub Trending"
cover: "https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/018-lark-cli-ai-feishu-cover.png"
---
...
![飞书 lark-cli 架构全景图：17 业务域覆盖与三层命令体系](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/018-lark-cli-ai-feishu-fig01-arch.png)
...
![lark-cli --dry-run 工作流：AI 提议 → dry-run 预览 → 人工确认 → 真实执行](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/018-lark-cli-ai-feishu-fig02-flow.png)
...
![24 个飞书 AI Agent Skills 架构：lark-shared 作为认证总闸，各业务 Skill 覆盖 11 核心域](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/018-lark-cli-ai-feishu-fig03-skills.png)
