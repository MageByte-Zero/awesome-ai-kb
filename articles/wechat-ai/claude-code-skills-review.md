---
title: "187K star 的 superpowers 我用了三个月：没你想的那么香"
description: "GitHub 上已有 1400+ Claude Code Skills，但真正能提效的不超过 10 个。本文结合 superpowers、claude-mem、agent-browser 等核心 skills 的真实使用体验，帮你筛掉那些噱头，找到真正值钱的那几个。"
date: "2026-05-12"
keywords: ["Claude Code Skills", "superpowers", "claude-mem", "agent-browser", "AI 编程效率"]
platform: "微信公众号"
source: "GitHub Skills 生态调研"
alt_titles:
  - "我试了 100 个 Claude Code Skills，70% 直接卸载"
  - "筛完 1400+ Skills，这 5 个让 Claude Code 效率提升 3 倍"
  - "装了一堆 Claude Code Skills，真正在用的就这几个"
  - "不会筛 Claude Code Skills，你的 API 账单就是冤枉钱"
---

# 187K star 的 superpowers 我用了三个月：没你想的那么香

![Claude Code Skills 评测封面：187K star 的 superpowers 没你想的那么香](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/claude-code-skills-review-cover.png)
*图：码哥字节 · Claude Code Skills 评测*
...
![Claude Code Skills 价值分层：哪些值得装，哪些是噱头](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/claude-code-skills-review-fig03-layer.png)
...
![superpowers 工作流：stock Claude Code vs superpowers 的决策差异](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/claude-code-skills-review-fig01-flow.png)
...
![Claude Code 浏览器自动化工具横向对比（2026）](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/claude-code-skills-review-fig02-matrix.png)
