---
title: "185,000 星的 Superpowers 插件，90% 的人只用了它 10% 的功能"
description: "Superpowers 是 Claude Code 上 Star 增长最快的工作流插件，但大多数人装完之后只会喊一句 /brainstorming。这篇文章从 SKILL.md 源文件出发，拆解 brainstorming、systematic-debugging、writing-plans、subagent-driven-development 等核心 skill 的真实运作机制，带你把完整工作流跑通。"
date: "2026-05-10"
keywords: ["Claude Code", "Superpowers", "brainstorming skill", "systematic-debugging", "writing-plans", "subagent-driven-development", "AI 编程工作流"]
platform: "微信公众号"
source: "GitHub Trending / 实测"
alt_titles:
  - "为什么 Superpowers 的 brainstorming skill 坚决不写代码？我翻了它的源文件"
  - "Claude Code 总是跳过测试、乱猜 bug？Superpowers 用 14 条铁律管住了它"
  - "装上 Superpowers 之后，我把 Claude Code 的无效 token 消耗降了一半"
  - "用了 Claude Code 三个月还在靠「帮我写这个功能」？Superpowers 工作流你该知道了"
---
...
![Superpowers 14 个 Skill 分类树状图](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/superpowers-skill-workflow-deep-dive-fig01-tree.png)
...
![systematic-debugging 四阶段调试流程图](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/superpowers-skill-workflow-deep-dive-fig02-flow.png)
...
![subagent-driven-development vs executing-plans 对比图](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/superpowers-skill-workflow-deep-dive-fig03-cmp.png)
...
![Superpowers 完整功能开发工作流](https://magebyte.oss-cn-shenzhen.aliyuncs.com/myself/superpowers-skill-workflow-deep-dive-fig04-flow.png)
