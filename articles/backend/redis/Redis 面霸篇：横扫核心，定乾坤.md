...
如果大家用心读完《[Redis 系列](https://mp.weixin.qq.com/mp/appmsgalbum?__biz=MzU3NDkwMjAyOQ==&action=getalbum&album_id=1708320618028318723&scene=173&from_msgid=2247487733&from_itemidx=1&count=3&nolastread=1#wechat_redirect)》并理解，吊打面试官根本不是事。

1. [Redis 核心篇：唯快不破的秘密](https://mp.weixin.qq.com/s/8HN1PqqU57Kdz9ERwDY2cw)
2. [Redis 日志篇：AOF 和 RDB 实现宕机快速恢复，数据不丢失](https://mp.weixin.qq.com/s/R-jZnjGNbOOL6zOtVd9omg)
3. [Redis 高可用篇：主从架构数据一致性同步原理](https://mp.weixin.qq.com/s/pWf72S9Pd6HRWg5MUlpr8Q)
4. [Redis 实战篇：6.x 版本 Sentinel 哨兵集群搭建](https://mp.weixin.qq.com/s/LZxKifLRFnqLiAeSSv7q9A)
5. [Redis 高可用篇：Sentinel 哨兵集群原理](https://mp.weixin.qq.com/s/rtgh5c6p5zhcfgGeqX5mZA)
6. [Redis 实战篇：6.x 版本 Cluster 集群搭建](https://mp.weixin.qq.com/s/gmTCxw92Ts0-lJs61DKztA)
7. [Redis 高可用篇：Cluster 集群能无限拓展么？原理是什么？](https://mp.weixin.qq.com/s/p9WoNI9o-UcD19QkJEnyWQ)
8. [Redis 实战篇：巧用 Bitmap 实现亿级海量数据统计](https://mp.weixin.qq.com/s/0fFqH83waCBiFZlM0lWIuQ)
9. [Redis 实战篇：巧用数据结构实现亿级数据统计](https://mp.weixin.qq.com/s/V-CGUfwqviv5QxOxFlESKA)
...
大家觉得有所帮助希望可以动动手指点赞、分享、收藏、留言呀，也可以加「码哥」微信「MageByte1024」进入专属读者群一起探讨更多面试遇到的问题，码哥知无不答。
