...
本文将用到 [String、Set、Zset、List、hash](https://mp.weixin.qq.com/s/8HN1PqqU57Kdz9ERwDY2cw) 以外的拓展数据类型 `Bitmap`、`HyperLogLog `来实现。
...
`opration` 可以是 `and`、`OR`、`NOT`、`XOR`。当 [BITOP](http://redisdoc.com/bitmap/bitop.html#bitop) 处理不同长度的字符串时，较短的那个字符串所缺少的部分会被当做 `0` 。

空的 `key` 也被看作是包含 `0` 的字符串序列。

便于理解，如下图所示：

![BITOP](https://magebyte.oss-cn-shenzhen.aliyuncs.com/redis/BITOP.png)
...
用户编号 89757 访问 「[Redis 为什么这么快 ](http://mp.weixin.qq.com/s?__biz=MzU3NDkwMjAyOQ==&mid=2247485665&idx=1&sn=3cf8e45aaa071fa26975bca34b8878e4&chksm=fd2a1283ca5d9b95889dbc3ec5949f784f6b8e6b469e49675731a8a544321fc4633058e27c41&scene=21#wechat_redirect)」时，我们将这个信息放到 Set 中。
...
![List最新列表](https://magebyte.oss-cn-shenzhen.aliyuncs.com/redis/List列表.png)
...
![交集](https://magebyte.oss-cn-shenzhen.aliyuncs.com/redis/交集.png)
...
![set差集](https://magebyte.oss-cn-shenzhen.aliyuncs.com/redis/set差集.png)
...
[Redis 核心篇：唯快不破的秘密](http://mp.weixin.qq.com/s?__biz=MzU3NDkwMjAyOQ==&mid=2247485665&idx=1&sn=3cf8e45aaa071fa26975bca34b8878e4&chksm=fd2a1283ca5d9b95889dbc3ec5949f784f6b8e6b469e49675731a8a544321fc4633058e27c41&scene=21#wechat_redirect)

[Redis 日志篇：无畏宕机快速恢复的杀手锏](http://mp.weixin.qq.com/s?__biz=MzU3NDkwMjAyOQ==&mid=2247485805&idx=1&sn=4b0ecabc972ce773e2484d1a473d0401&chksm=fd2a130fca5d9a19f599a62b6b3d83c62e1a8ff72e41ad5b06f46757f7c3051a3cb77dae8be5&scene=21#wechat_redirect)

[Redis 高可用篇：你管这叫主从架构数据同步原理？](http://mp.weixin.qq.com/s?__biz=MzU3NDkwMjAyOQ==&mid=2247486453&idx=1&sn=8c073df56600ac992c8a5a742b255703&chksm=fd2a1197ca5d98812d23e4b9a7494ddc4c2daf7d78c270b77d083b3935ef48e0874f729270d8&scene=21#wechat_redirect)

[Redis 高可用篇：你管这叫 Sentinel 哨兵集群原理](http://mp.weixin.qq.com/s?__biz=MzU3NDkwMjAyOQ==&mid=2247486656&idx=1&sn=756ad89eeaf6ed8f00781b9163655374&chksm=fd2a16a2ca5d9fb49e5a473fff61fcdd7332e68f488e55366452c3821d6480de3690ade131c6&scene=21#wechat_redirect)

[Redis 高可用篇：Cluster 集群能支撑的数据有多大？](http://mp.weixin.qq.com/s?__biz=MzU3NDkwMjAyOQ==&mid=2247486913&idx=1&sn=2d386a862636ebb258084cbb16e43a12&chksm=fd2a17a3ca5d9eb5ddec9d4e1605da7c616e6bbebe8d4cdf6afb7b4a8b4daa72170bc1fd84df&scene=21#wechat_redirect)
