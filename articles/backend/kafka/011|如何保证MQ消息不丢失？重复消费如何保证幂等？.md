...
![](https://magebyte.oss-cn-shenzhen.aliyuncs.com/redis/202507201134526.png)
...
![](https://magebyte.oss-cn-shenzhen.aliyuncs.com/redis/202507201144840.png)

你可以发现，从生产者发送消息，MQ 保存消息，消费者消费消息，每一个环节都有可能丢失消息。

![](https://magebyte.oss-cn-shenzhen.aliyuncs.com/redis/202507201157048.png)
...
![](https://magebyte.oss-cn-shenzhen.aliyuncs.com/redis/202507201203516.png)
...
![](https://magebyte.oss-cn-shenzhen.aliyuncs.com/redis/202507201253892.png)
...
![](https://magebyte.oss-cn-shenzhen.aliyuncs.com/redis/202507201325231.png)
...
![](https://magebyte.oss-cn-shenzhen.aliyuncs.com/redis/202507201258737.png)
...
- min.insync.replicas：定义 **最小同步副本数**，必须至少有 2 个副本处于同步状态（含 Leader）。
  - 当 `replication.factor=3` 且 `min.insync.replicas=2` 时：允许 1 个副本宕机（如 Broker 故障）、若 2 个副本不可用，则生产会被阻塞
...
![](https://magebyte.oss-cn-shenzhen.aliyuncs.com/redis/202507201332001.png)
...
![](https://magebyte.oss-cn-shenzhen.aliyuncs.com/redis/202507201338157.png)
