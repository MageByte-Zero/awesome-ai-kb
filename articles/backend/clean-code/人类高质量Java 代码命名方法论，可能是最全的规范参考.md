...
![](https://magebyte.oss-cn-shenzhen.aliyuncs.com/redis/20211211234903.png)*
...
比如应用[模板方法设计模式](https://mp.weixin.qq.com/s/H9SMZmWkL3NMfLJiz_XnRg)将不变的算法逻辑框架定义出来，把变化的点延迟到子类重写。
...
2. `XYZStringHandler `与 `XYZStringStorage`。
3. `UserController `与 `UserInfoController`。
...
### 4.7 与集合操作相关的方法[#](https://www.cnblogs.com/liqiangchn/p/12000361.html#1717308821)
...
大家在工作中是否有遇到一些垃圾命名的代码呢？欢迎在留言区留言与码哥一起吐槽。