...
![](https://magebyte.oss-cn-shenzhen.aliyuncs.com/算法/20200406202331.png)
...
![](https://magebyte.oss-cn-shenzhen.aliyuncs.com/算法/20200406210730.png)
...
![应用层协议抽象](https://magebyte.oss-cn-shenzhen.aliyuncs.com/tomcat/20200407174647.png)

总结下来，连接器的三个核心组件 `Endpoint`、`Processor`和 `Adapter`来分别做三件事情，其中 `Endpoint`和 `Processor`放在一起抽象成了 `ProtocolHandler`组件，它们的关系如下图所示。

![连接器](https://magebyte.oss-cn-shenzhen.aliyuncs.com/tomcat/20200407174755.png)
...
![NioEndPoint](https://magebyte.oss-cn-shenzhen.aliyuncs.com/tomcat/NioEndPoint.jpg)
...
![](https://magebyte.oss-cn-shenzhen.aliyuncs.com/tomcat/20200407180342.png)
...
![容器](https://magebyte.oss-cn-shenzhen.aliyuncs.com/tomcat/20200407185056.png)
...
![](https://magebyte.oss-cn-shenzhen.aliyuncs.com/tomcat/20200407192105.png)
...
![](https://magebyte.oss-cn-shenzhen.aliyuncs.com/tomcat/20200407193058.png)
...
![`Lyfecycle` ](https://magebyte.oss-cn-shenzhen.aliyuncs.com/tomcat/Lifecycle.png)
...
![](https://magebyte.oss-cn-shenzhen.aliyuncs.com/tomcat/20200510102153.png)
...
![类加载器](https://magebyte.oss-cn-shenzhen.aliyuncs.com/tomcat/类加载器.jpg)
...
![Tomcat 整体组件关系](https://magebyte.oss-cn-shenzhen.aliyuncs.com/tomcat/组件关系.jpg)
...
![](https://magebyte.oss-cn-shenzhen.aliyuncs.com/tomcat/20200408181555.png)
...
![](https://magebyte.oss-cn-shenzhen.aliyuncs.com/tomcat/20200510182217.png)
...
![](https://magebyte.oss-cn-shenzhen.aliyuncs.com/tomcat/20200427184859.png)
