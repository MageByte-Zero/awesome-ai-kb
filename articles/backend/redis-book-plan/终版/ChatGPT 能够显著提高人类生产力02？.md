...
张无剑居安思危，**想系统化地学习 Redis 技术，提高自己的竞争力**。网络上铺天盖地地宣传 ChatGPT 强大，就计划用 ChatGPT 来梭哈一把。

在询问之前，张无剑**花了很多时间研究如何更好地给出提示语，因为没有好的提示语，ChatGPT 给出的答案可能有点“智障”。**

![](https://magebyte.oss-cn-shenzhen.aliyuncs.com/redis/202407071732571.png)

花了很多时间学会了提示技巧后，询问 ChatGPT 得到一份学习计划。
...
> 假如你是一个资深 Redis 7.0 技术培训老师，我是你的学生。根据你列出的学习目标 “Redis 基础入门”，学习内容为“Redis 数据类型 List 底层实现原理和实战技巧” ，我的目标是掌握这些数据类型的底层实现原理和实战技巧，原理讲解要深入一些，我的目标是成为 Redis 高手。
...
1. **无图无真相，无法理解 List 底层的两种数据结构（Linkedlist、Ziplist）到底是啥样的，内容不够深。**
...
5. 还要花费大量时间来调教 ChatGPT 纠正错误，可本身自己是来学习的，如何纠正呢？
